...
<section class="slick-slideshow">   
                <div class="slick-custom">
                    <img src="<?php echo O_IMG_DIR ?>/slideshow/medium-shot-business-women-high-five.jpeg" class="img-fluid" alt="">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    ...
                                    <a href="<?php echo get_site_url() . '/about' ?>" class="btn custom-btn">Learn more about us</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slick-custom">
                    <img src="<?php echo O_IMG_DIR ?>/slideshow/team-meeting-renewable-energy-project.jpeg" class="img-fluid" alt="">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    ...
                                    <a href="<?php echo get_site_url() . '/products' ?>" class="btn custom-btn">Explore products</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="slick-custom">
                    <img src="<?php echo O_IMG_DIR ?>/slideshow/two-business-partners-working-together-office-computer.jpeg" class="img-fluid" alt="">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-10">
                                    ...
                                    <a href="<?php echo get_site_url() . '/contact' ?>" class="btn custom-btn">Work with us</a>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-10 col-12">
                            <div class="tab-content mt-2" id="pills-tabContent">
                                <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="<?php echo O_IMG_DIR ?>/pim-chu-z6NZ76_UTDI-unsplash.jpeg" class="img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                ...
                                                <p>Little Fashion templates comes with <a href="<?php echo get_site_url() . '/sign_in' ?>">sign in</a> / <a href="<?php echo get_site_url() . '/sign_up' ?>">sign up</a> pages, product listing / product detail, about, FAQs, and contact page.</p>
                                                ...
                                                <div class="mt-2 mt-lg-auto">
                                                    <a href="<?php echo get_site_url() . '/about' ?>" class="custom-link mb-2">
                                                        Learn more about us
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                ...
                                                <div class="mt-2 mt-lg-auto">
                                                    <a href="<?php echo get_site_url() . '/contact' ?>" class="custom-link mb-2">
                                                        Work with us
                                                        <i class="bi-arrow-right ms-2"></i>
                                                    </a>
                                                </div>
                                ...
                                <div class="tab-pane fade" id="pills-skill" role="tabpanel" aria-labelledby="pills-skill-tab">
                                    <div class="row">
                                        <div class="col-lg-7 col-12">
                                            <img src="<?php echo O_IMG_DIR ?>/cody-lannom-G95AReIh_Ko-unsplash.jpeg" class="img-fluid" alt="">
                                        </div>
                                        ...
                                        <div class="col-lg-5 col-12">
                                            <div class="d-flex flex-column h-100 ms-lg-4 mt-lg-0 mt-5">
                                                ...
                                                <div class="mt-2 mt-lg-auto">
                                                    <a href="<?php echo get_site_url() . '/products' ?>" class="custom-link mb-2">
                                                        Explore products
                                                        <i class="bi-arrow-right ms-2"></i>
                                                    </a>
                                                </div>
                ...
                <div class="container-fluid p-0">
                    <div class="row align-items-center">
                        ...
                        <div class="col-lg-6 col-12">
                            <img src="<?php echo O_IMG_DIR ?>/retail-shop-owner-mask-social-distancing-shopping.jpg" class="img-fluid" alt="">
                        </div>
                        ...
                        <div class="col-lg-6 col-12">
                            <div class="px-5 py-5 py-lg-0">
                                ...
                                <a href="<?php echo get_site_url() . '/products' ?>" class="custom-link">
                                    Explore Products
                                    <i class="bi-arrow-right ms-2"></i>
                                </a>
                            </div>
...
?>
                        ...
                        <?php wp_reset_query(); $query__featured = new WP_Query($query_featured_products); ?>
                    
                    <?php if ($query__featured->have_posts()) {while ($query__featured->have_posts()) {
                        $query__featured->the_post();
                        ?>
                        <div class="col-lg-4 col-12 mb-3">
                            <div class="product-thumb">
                                ...
                                <div class="product-top d-flex">
                                    ...
                                    <?php $tags_arr_new_arrivals = get_the_tags(); ?>

                                    <?php echo $tags_arr_new_arrivals ? "<span class=\"product-alert me-auto\">{$tags_arr_new_arrivals[0]->name}</span>" : null; ?>
    ...
    ?>        
                        ...
                        <div class="col-12 text-center">
                            <a href="<?php echo get_site_url() . '/products' ?>" class="view-all">View All Products</a>
                        </div>
